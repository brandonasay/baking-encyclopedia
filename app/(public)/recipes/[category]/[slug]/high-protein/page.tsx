...
export default async function HighProteinVariantPage({ params }: Props) {
  ...
  // Redirect to standard recipe if HP variant not available
  if (!recipeData.has_high_protein) {
    ...
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F4]">
        ...
        <div className="relative bg-[#1C1410] text-white overflow-hidden">
          <div className="absolute inset-0">
            {recipe.image_url ? (
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-800/50 to-[#1C1410]" />
            )}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {/* HP notes */}
          {recipe.high_protein_notes && (
            <div className="mb-10 p-5 bg-blue-50 rounded-xl border-l-4 border-blue-500">
              <p className="text-sm text-blue-900 leading-relaxed">{recipe.high_protein_notes}</p>
            </div>
          )}
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <aside className="hidden lg:block lg:w-72 shrink-0">
              <div className="sticky top-6 bg-white rounded-2xl border border-[#E8E0D5] overflow-hidden">
                <div className="px-5 py-4 bg-blue-50 border-b border-[#E8E0D5]">
                  <h2
